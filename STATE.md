...
**Phase** : 🟡 Plan validé, implémentation non commencée.

**Branche de travail** : `web/v0.1` (à créer quand on démarre l'implémentation). Actuellement sur `claude/pedantic-feynman-3f4467` (worktree de setup docs).

**Dernière action** : Rédaction des fichiers de reprise (`CLAUDE.md`, `SPECS.md`, `STATE.md`) à partir du plan validé avec l'utilisateur.

**Prochaine étape** : Étape 1 de la checklist — créer les 3 `game.json` d'exemple (avec champs `build` adaptés à chaque organisation).
...
- [ ] **1. Créer un `game.json` pour chacun des 3 jeux d'exemple** (avec champ `build` adapté)
...
- [ ] **3. Créer un `cover.png` pour chacun des 3 jeux d'exemple**
...
- [ ] **5. Types + scripts build (génériques)**
...
- [ ] **6. Test local du script d'export**
...
- [ ] **8. Styles globaux**
  ...
  - Grid responsive.
- [ ] **9. Mettre à jour `.gitignore` racine**
...
- [ ] **11. README racine — guide participant**
